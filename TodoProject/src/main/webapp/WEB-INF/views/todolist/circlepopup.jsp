    ...
    <script>
        ...
        function confirm_reset() {
            if (confirm("정말 삭제하시겠습니까?") == true) {
                location.href = '/todo/todolist/circledel.do';
            } else {
                return false;
            }
        }
...
<div class="form-popup-container" id="login-form-popup-container">
    <form name="form-popup" class="form-popup" id="login-form-popup" action="/todo/todolist/circlepopupok.do">
        ...
        <form action="/todo/todolist/circledel.do">
            <div>
